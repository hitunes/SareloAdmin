                ...
                <div class="page-sidebar navbar-collapse collapse">
                        <ul class="page-sidebar-menu">
                            ...
                            <li class="nav-item active open">
                                <a href="{{url('/admin/slots/edit')}}" class="nav-link ">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase"> Edit Unit Type {{$unittype->id}} </span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        ...
                                        <a href="{{ url('/admin/unit-types/') }}" title="Back">
                                            <button class="btn btn-danger btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
                                        </a>
                                        <br />
                                        <br />
                                        <div class="row">
                                            <form method="POST" action="{{url('admin/unit-types/update',$unittype->id)}}">
                                                {{csrf_field()}}
                                                @if ($errors->any())
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit UnitType #{{ $unittype->id }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::model($unittype, [
                            'method' => 'PATCH',
                            'url' => ['/admin/unit-types', $unittype->id],
                            'class' => 'form-horizontal',
                            'files' => true
                        ]) !!}

                        @include ('admin.unit-types.form', ['submitButtonText' => 'Update'])
