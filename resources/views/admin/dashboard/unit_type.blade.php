                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            ...
                                            {{ $unittypes->links() }}  <br> <br>
                                            <a href="{{ url('/admin/unit-types/create') }}" class="btn btn-success btn-sm" title="Add New Slot">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
                                            ...
                                            <tbody>
                                                <?php $num = 1; ?>
                                                <form method="POST" action="{{url('admin/unit-type/delete/,$unit-types->id')}}">
                                                    @foreach($unittypes as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="btn btn-primary btn-xs" href="{{ url('/admin/unit-types/edit/' . $item->id) }}" title="Edit Unit Type">Edit</a>
                                                                {!! Form::open([
                                                                    'style' => 'display:inline'
                                                                ]) !!}
                                                               <a class="btn btn-danger btn-xs" id="a_del" oncick =ConfirmDelete() href="{{ url('/admin/unit-types/delete/' . $item->id) }}" title="Delete Slot">Delete</a>
                                                                {!! Form::close() !!}
                                                            </td>
                                                        </tr>
                                                    @endforeach
