            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="invoice row">
                        <div class="invoicename">RECEIPT</div>
                        <div class="logo">
                        ...
                        <div class="line row">
                            ...
                            <div class="col-md-6 col-xs-6 padding-0 text-right">
                                ...
                                <h2>{{$order->order_unique_reference}}</h2>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                ...
                                @foreach($order->order_products as $order_product)
                                    <tr>
                                        ...
                                        <td>&#x20A6; {{number_format($order_product->product->price)}}</td>
                                        <td>&#x20A6; {{number_format($order_product->subtotal)}}</td>
                                    </tr>
                                @endforeach
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td><h4 class="total">&#x20A6; {{number_format($order->total)}}</h4></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="footy">
                        <ul>
                            <li class="col-md-4"><a href="#">Privacy</a></li>
                            <li class="col-md-4"><a href="#">Terms and Condition</a></li>
                            <li class="col-md-4"><a href="#">Feedbacks</a></li>
                        </ul>
                    </div>
