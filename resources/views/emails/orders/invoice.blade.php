...
<body class="clearfix">
    <div class="main clearfix">
            ...
            <div class="row">
                <!-- START CONTAINER -->
                <div class="col-md-6 col-md-offset-3" style="max-width: 500px; width: 50%;margin: 0 auto;padding-left: 15px;padding-right: 15px;">

                    <!-- Start Invoice -->
                    <div class="invoice row" style="background: #fff;position: relative;padding: 50px;border: 1px solid #ccc;font-family: 'Montserrat', sans-serif;">
                        <div class="invoicename" style="color: #E4E4E4;font-weight: bold;font-size: 15px;right: 50px;top: 50px;position: absolute;">RECEIPT</div>
                        <div class="logo" style="line-height: 26px;text-align: center; color: #76747A;font-size: 12px !important;
                            font-weight: 300;font-family: 'Open Sans', sans-serif;font-size: 16px;">
                        ...
                        <!--<img src="assets/img/logo/sarelo2.svg" alt="logo">-->
                            <br>
                            <p>Co-Creation Hub | 6th Floor, 294 Herbert Macaulay Way<br>
                            Yaba Lagos State, Nigeria.<br>
                            Tel: +234 (01) 2950555
                            </p>
                        </div>

                        <div class="line row" style="border-bottom: 2px solid #E4E4E4;padding: 30px 0;margin-right: -15px;
    margin-left: -15px;">
                            <div class="col-md-6 col-xs-6" style="display:inline-block; text-align:left; width: 50%;margin: 20px auto;padding-left: 15px;padding-right: 15px;">
                                <h4 style="margin: 0;color: #76747A;font-weight: bold;font-size: 14px;">PURCHASE DATE</h4>
                                <h2 style="color: #37353E;font-weight: normal;font-size: 14px;margin: 0;letter-spacing: -0.02em;">{{date('d M, Y', strtotime($order->created_at))}}</h2>
                            </div>
                            <div class="col-md-6 col-xs-6" style="display:inline-block; text-align:left; width: 50%;margin: 0 auto;padding-left: 15px;padding-right: 15px;">
                                <h4  style="margin: 0;color: #76747A;font-weight: bold;font-size: 14px;">Transaction Code</h4>
                                <h2 style="color: #37353E;font-weight: normal;font-size: 14px;margin: 0;letter-spacing: -0.02em;">{{$order->order_unique_reference}}</h2>
                            </div>
                        </div>

                        <div class="line row" style="border-bottom: 2px solid #E4E4E4;padding: 30px 0;margin-right: -15px;
    margin-left: -15px;">
                        <div class="col-md-6 col-xs-6"  style="display: inline-block;text-align:left; width: 35%;margin: 0 auto;padding-left: 15px;padding-right: 15px;">
                            <h4 style="margin: 0;color: #76747A;font-weight: bold;font-size: 14px;">PREPARED FOR</h4>
                            <h2 style="color: #37353E;font-weight: normal;font-size: 14px;margin: 0;letter-spacing: -0.02em;">{{$order->user->first_name}} {{$order->user->last_name}}</h2>
                        </div>
                        <div class="col-md-6 col-xs-6"  style="display: inline-block; text-align:right; width: 45%;margin: 0 auto;padding-left: 15px;padding-right: 15px; text-align: right;">
                            <h4 style="margin: 0;color: #76747A;font-weight: bold;font-size: 14px;">PACKAGE</h4>
                            <h2 style="color: #37353E;font-weight: normal;font-size: 14px;margin: 0;letter-spacing: -0.02em;">Personal</h2>
                        </div>
                        </div>
                        <div class="table-responsive table-full-width">
                            <table class="table" style="margin-top: 40px;color: #37353E;width: 100%;border-spacing: 0;border-collapse: collapse;">
                                <thead class="title" style="font-size: 10px;color: #76747A; font-weight: 600;font-family: 'Montserrat', sans-serif;text-transform: uppercase;">
                                    <tr>
                                        <td style="padding-left: 0px;padding-right: 0px; text-align: left;">PRODUCT DESCRIPTION</td>
                                        <td style="padding-left: 0px; padding-right: 0px; display: table-cell; text-align:center;">UNIT</td>
                                        <td style="padding-left: 0px; padding-right: 0px; display: table-cell; text-align:center;">RATE PER UNIT</td>
                                        <td style="padding-left: 0px; padding-right: 0px; display: table-cell; text-align:right;">TOTAL</td>
                                    </tr>
                                </thead>
                                <tbody style="font-size: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-top: 1px solid #ddd; padding: 15px">&#x20A6; {{number_format($order_product->product->price, 2)}}</td>
                                        <td style="border-top: 1px solid #ddd; padding: 0px; text-align: right;">&#x20A6; {{number_format($order_product->sub_total, 2)}}</td>
                                    </tr>
                                    @endforeach
                                    <tr>
                                        ...
                                        <td style="border-top: 1px solid #ddd; padding: 15px"></td>
                                        <td style="border-top: 1px solid #ddd; padding: 0px; text-align: right;"><h4 class="total">&#x20A6; {{number_format($order->total, 2)}}</h4></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

                        <div class="signature" style="color: #333;border-bottom: 2px solid #E4E4E4;border-top: 2px solid #E4E4E4;margin: 20px 0;padding: 20px 0;">
                            <p><img src="assets/img/signature.png" alt="Signature" width="100px"></p>
                            <p><b>JJ Jones</b>, CEO</p>
                        </div>

                        <div class="bottomtext" style="    color: #333;font-size: 11px;font-family: 'Open Sans', sans-serif;">
                    ...
                    <div class="footy">
                        <ul style="list-style-type: none;">
                            <li class="col-md-4" style="width: calc(100%/3);text-align: center; float: left;min-height: 1px;"><a href="#">Privacy</a></li>
                            <li class="col-md-4" style="width: calc(100%/3);text-align: center; float: left;min-height: 1px;"><a href="#">Terms and Condition</a></li>
                            <li class="col-md-4" style="width: calc(100%/3);text-align: center; float: left;min-height: 1px;"><a href="#">Feedbacks</a></li>
                        </ul>
                    </div>
